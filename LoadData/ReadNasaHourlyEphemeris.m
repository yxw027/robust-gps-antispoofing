function [allGpsEph,allGloEph] = ReadNasaHourlyEphemeris(utcTime)
%[allGpsEph,allGloEph] = ReadNasaHourlyEphemeris(utcTime,dirName)
...
%
%examples of how to call ReadNasaHourlyEphemeris:
...
% ReadNasaHourlyEphemeris will automatically uncompress it, if you have the right 
...
% Search for 'uncompress' in the ReadNasaHourlyEphemeris function to find and 
...
allGpsEph=[];allGloEph=[];
config = SetConfig;
dirName = [config.Base,'HourlyEphemeris/'];
...
if ~bGotGpsEph
    ...
    if any(sysFlag)
        fprintf('\nError in ReadNasaHourlyEphemeris.m\n')
        fprintf('%s',result);
...
end %end of function ReadNasaHourlyEphemeris
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
